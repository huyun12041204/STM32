...
#ifdef TFTLCD_R61509V
        LCD_WriteCmd(0x0001);
        LCD_WriteData(0x0000);//摄像头需要镜像所以设置为0x0100，正常0x0000
        LCD_WriteCmd(0x0003);
...
#ifdef TFTLCD_ILI9341
        LCD_WriteCmd(0x36);   //设置彩屏显示方向的寄存器
        LCD_WriteData(0x28);  //摄像头需要镜像所以设置为0X28，正常是0X68
        tftlcd_data.height=240;
        tftlcd_data.width=320;
#endif
...
void TFTLCD_Init(void)
{
...
#if 0
    LCD_WriteCmd(0x00);
    LCD_WriteCmd(0x00);//Initial Sync don't remove
    LCD_WriteCmd(0x00);
    LCD_WriteCmd(0x00);
    delay_ms(10);
    LCD_WriteCmd(0x00);
    ...
    LCD_WriteCmd(0x00);
    LCD_WriteData(0x01);
    LCD_WriteData(0x09);  // Gamma Control
    LCD_WriteCmd(0x03);
    LCD_WriteCmd(0x01);
    LCD_WriteData(0x7E);
    LCD_WriteData(0x0A);
    ...
    LCD_WriteCmd(0x10);
    LCD_WriteData(0x00);
    LCD_WriteData(0x10);  // Frame frequence
    LCD_WriteCmd(0x00);
    LCD_WriteCmd(0x11);
    LCD_WriteData(0x02);
    LCD_WriteData(0x02);  //
    ...
    LCD_WriteCmd(0x00);
    LCD_WriteData(0x00);
    LCD_WriteData(0x00);  // VGH/VGL 6/-3
    LCD_WriteCmd(0x01);
    LCD_WriteCmd(0x01);
    LCD_WriteData(0x00);
    ...
    LCD_WriteCmd(0x80);
    LCD_WriteData(0x00);
    LCD_WriteData(0x00);  // VCM
    delay_ms(200);//delay_ms 200ms
    LCD_WriteCmd(0x01);
    LCD_WriteCmd(0x00);
    LCD_WriteData(0x03);
    LCD_WriteData(0x30);  // VGH/VGL 6/-3
    LCD_WriteCmd(0x01);
    LCD_WriteCmd(0x01);
    LCD_WriteData(0x02);
    LCD_WriteData(0x47);  // VCI1
    delay_ms(50);//delay_ms 50ms
    LCD_WriteCmd(0x01);
    LCD_WriteCmd(0x02);
    LCD_WriteData(0xD1);
    LCD_WriteData(0xB0);  // VREG1
    delay_ms(50);//delay_ms 50ms
    LCD_WriteCmd(0x01);
    LCD_WriteCmd(0x03);
    LCD_WriteData(0x10);
    LCD_WriteData(0x00);  // VDV          //0900
    LCD_WriteCmd(0x02);
    LCD_WriteCmd(0x80);
    LCD_WriteData(0xC6);
    LCD_WriteData(0x00);  // VCM          //chenyu 0xc600
    ...
    LCD_WriteCmd(0x20);
    LCD_WriteData(0x00);
    LCD_WriteData(0x00);//H Start
    LCD_WriteCmd(0x00);
    LCD_WriteCmd(0x21);
    LCD_WriteData(0x00);
    LCD_WriteData(0x00);//V Start
    LCD_WriteCmd(0x00);
    LCD_WriteCmd(0x29);
    LCD_WriteData(0x00);
    LCD_WriteData(0x52);
    ...
    LCD_WriteCmd(0x07);
    LCD_WriteData(0x01);
    LCD_WriteData(0x00);//DISPLAY ON
    delay_ms(50);
    LCD_WriteCmd(0x00);
    LCD_WriteCmd(0x22);//GRAM Data Write
#endif
    ...
    LCD_WriteCmd(0x0100);
    LCD_WriteData(0x0330);
    LCD_WriteCmd(0x0101);
    LCD_WriteData(0x0336);
    LCD_WriteCmd(0x0103);
    LCD_WriteData(0x1000);

    LCD_WriteCmd(0x0280);
    LCD_WriteData(0x6100);
    LCD_WriteCmd(0x0102);
    LCD_WriteData(0xBBB4);
    delay_ms(100);

    LCD_WriteCmd(0x0001);
    LCD_WriteData(0x0100);
    LCD_WriteCmd(0x0002);
    LCD_WriteData(0x0000);//IB8消掉波纹
    LCD_WriteCmd(0x0003);
    LCD_WriteData(0x1030);
    LCD_WriteCmd(0x0009);
    LCD_WriteData(0x0100);
...
//	LCD_WriteCmd(0xC2,0x00);	LCD_WriteData(0x00,0x03);
    ...
    LCD_WriteData(0x0000);
    LCD_WriteCmd(0xD103);
    LCD_WriteData(0x0049);
    LCD_WriteCmd(0xD104);
    LCD_WriteData(0x0000);
    LCD_WriteCmd(0xD105);
    LCD_WriteData(0x006B);
    LCD_WriteCmd(0xD106);
    LCD_WriteData(0x0000);
    LCD_WriteCmd(0xD107);
    LCD_WriteData(0x0086);
    LCD_WriteCmd(0xD108);
    LCD_WriteData(0x0000);
    LCD_WriteCmd(0xD109);
    LCD_WriteData(0x009D);
    LCD_WriteCmd(0xD10A);
    LCD_WriteData(0x0000);
    LCD_WriteCmd(0xD10B);
    LCD_WriteData(0x00C3);
    LCD_WriteCmd(0xD10C);
    LCD_WriteData(0x0000);
    LCD_WriteCmd(0xD10D);
    LCD_WriteData(0x00E0);
    LCD_WriteCmd(0xD10E);
    LCD_WriteData(0x0001);
    LCD_WriteCmd(0xD10F);
    ...
    LCD_WriteData(0x0001);
    LCD_WriteCmd(0xD117);
    LCD_WriteData(0x00BD);
    LCD_WriteCmd(0xD118);
    LCD_WriteData(0x0001);
    LCD_WriteCmd(0xD119);
    LCD_WriteData(0x00E7);
    LCD_WriteCmd(0xD11A);
    LCD_WriteData(0x0001);
    LCD_WriteCmd(0xD11B);
    LCD_WriteData(0x00E8);
    LCD_WriteCmd(0xD11C);
    ...
    LCD_WriteData(0x0002);
    LCD_WriteCmd(0xD123);
    LCD_WriteData(0x0063);
    LCD_WriteCmd(0xD124);
    LCD_WriteData(0x0002);
    LCD_WriteCmd(0xD125);
    LCD_WriteData(0x007E);
    LCD_WriteCmd(0xD126);
    LCD_WriteData(0x0002);
    LCD_WriteCmd(0xD127);
    LCD_WriteData(0x00B1);
    LCD_WriteCmd(0xD128);
    LCD_WriteData(0x0002);
    LCD_WriteCmd(0xD129);
    LCD_WriteData(0x00E0);
    ...
    LCD_WriteData(0x0003);
    LCD_WriteCmd(0xD12F);
    LCD_WriteData(0x00B4);
    LCD_WriteCmd(0xD130);
    LCD_WriteData(0x0003);
    LCD_WriteCmd(0xD131);
    LCD_WriteData(0x00B9);
    LCD_WriteCmd(0xD132);
    LCD_WriteData(0x0003);
    LCD_WriteCmd(0xD133);
    ...
    */
    LCD_WriteCmd(0x3600);
    LCD_WriteData(0x00C0);//调整扫描方式和RGB  BGR
    LCD_WriteCmd(0x3500);
    LCD_WriteData(0x0000);

    LCD_WriteCmd(0x3A00);
    LCD_WriteData(0x0005);	//70
...
void LCD_ShowChar(u16 x,u16 y,u8 num,u8 size,u8 mode)
{
    ...
    for(t=0; t<csize; t++)
    {
        ...
        else if(size==32)temp=ascii_3216[num][t];	//调用2412字体
        else return;								//没有的字库
        for(t1=0; t1<8; t1++)
        {
